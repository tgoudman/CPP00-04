...
/*   Updated: 2025/05/05 12:24:16 by tgoudman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		hitPoints -= amount;
		std::cout << BLUE << name << RESET << " has taken "  
...
void		ClapTrap::beRepaired(unsigned int amount)
{
	if (energyPoints && hitPoints)
	{
		hitPoints += amount; 
		energyPoints--;
		std::cout << BLUE << name << RESET << " repaired itself and gained " 
		<< amount << " of hit points, he now has " << hitPoints << " hit points." 
		<< std::endl;
	}
	else if (!energyPoints)
	{
