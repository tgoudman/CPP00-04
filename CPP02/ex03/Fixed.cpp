...
/*   Updated: 2025/05/01 15:49:59 by tgoudman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	// std::cout << "Custom Int constructor Fixed called" << std::endl;
	this->_nb = input << this->_bits;
}
Fixed::Fixed(const float input)
{
	// std::cout << "Custom float constructor Fixed called" << std::endl;
	_nb = roundf(input * (1 << _bits));
}

Fixed::Fixed(const Fixed &copie)
{
	// std::cout << "Copie constructor Fixed called" << std::endl;
	*this = copie;
}
